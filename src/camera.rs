...
mod tests {
    ...
    fn it_creates_a_camera() {
        ...
        let camera = new(hsize, vsize, field_of_view);
    ...
    fn constructing_a_ray_when_the_camera_is_transformed() {
        let mut camera = new(201, 101, PI / 2.);
